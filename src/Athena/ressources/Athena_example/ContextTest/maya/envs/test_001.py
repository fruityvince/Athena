...
register = \
{
    ...
    ID.TestCheck:
        {
            'process': 'Athena.ressources.Athena_example.ContextTest.maya.processes.testCheck.TestCheck',
            'category': 'Sanity Test',
        }, 

    ID.NoStaticAnimKeys:
        {
            'process': 'Athena.ressources.Athena_example.ContextTest.maya.processes.noStaticAnimKeys.NoStaticAnimKeys',
            'category': 'Animation',
        },
}
